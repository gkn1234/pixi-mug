...
export default class GameScene extends Scene {
  ...
  initNoteContainer () {
    ...
    this.noteContainer.position.set(Game.config.width / 2, size.tureHeight)
    
    // 容器皮肤
    const containerSkin = new PIXI.projection.Sprite2d(this.sheet.textures['board.png'])
    containerSkin.anchor.set(0.5, 1)
    containerSkin.width = size.containerWidth * (size.tureHeight / size.containerHeight)
